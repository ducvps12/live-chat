...
const doc = {
  ...
  paths: {
        ...
        "parameters": [
          {
            ...
            "schema": {
              "type": "object",
              "properties": {
                "token": { "type": "string", "description": "JWT verification token from email" }
              },
              "required": ["token"]
            }
          }
    ...
    "/api/auth/verify-password": {
      "post": {
        "tags": ["Auth"],
        "summary": "Verify Password (Re-authentication)",
        "description": "Verify password without logging in. Used for sensitive operations.",
        "security": [{ "bearerAuth": [] }],
        "parameters": [
          {
            "name": "body",

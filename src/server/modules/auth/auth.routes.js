...
router.post('/verify-email', limiters.auth, validate(schemas.verifyEmail), authController.verifyEmail);
router.post('/resend-verification', limiters.auth, validate(schemas.resendVerification), authController.resendVerification);
